...
const PreLoader = () => {
  ...
  return (
    <div className='h-[100vh] m-0 flex justify-center items-center flex-col'>
      ...
      <div className='lg:h-[80%] lg:flex flex-col gap-1 justify-end items-center py-20 h-[60%] hidden '>
        
        <h1 className='text-4xl italic font-bold text-white'>Gearshift Garages</h1>
